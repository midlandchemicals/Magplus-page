...
export function CaPITALPage({ onSubmit }: ContactFormProps) {
  ...
  const benefits = [
    {
      ...
      description: "The provision of optimum levels of Calcium are important for root development, maintaining plant health and strengthening cell walls for improved quality and shelf life"
    },
    {
      icon: <Shield className="h-8 w-8 text-blue-600" />,
      title: "Plant Health",
      description: "Maintains overall plant health through superior calcium nutrition and phosphite technology"
    },
    {
      icon: <Layers className="h-8 w-8 text-purple-600" />,
      title: "Strengthens Cell Walls",
      description: "Calcium strengthens cell walls for improved crop quality and extended shelf life"
    },
    {
      icon: <Zap className="h-8 w-8 text-orange-600" />,
      title: "Fast-Acting Nutrition",
      description: "Formulated for rapid absorption and maximum availability at key growth stages"
    },
    {
      icon: <Target className="h-8 w-8 text-cyan-600" />,
      title: "Vegetable & Salad Specialist",
      description: "Specifically formulated for vegetable and salad crops with proven phosphite technology"
    },
    {
      icon: <Atom className="h-8 w-8 text-green-500" />,
      title: "Enhanced Formulation",
      description: "Contains high levels of soluble calcium with key nutrients boron and zinc"
    }
  ];
  ...
  const crops = [
    {
      name: "Potatoes",
      rate: "2.0 l/ha",
      timing: "Apply at start of tuber bulking. Repeat @ 2.0 l/ha during tuber bulking",
      color: "bg-orange-100 text-orange-800"
    },
    {
      name: "Roots",
      rate: "2.0-3.0 l/ha",
      timing: "Apply @ 4-6 true leaves. Repeat every 14-21 days depending on growing season",
      color: "bg-amber-100 text-amber-800"
    },
    {
      name: "Brassicas*",
      rate: "2.0-3.0 l/ha",
      timing: "Apply from 4-6 true leaves. Repeat at 10-14 day intervals as required",
    ...
    scientificBenefits: [
      {
        ...
        description: "Advanced phosphite formulation provides immediate plant availability and systemic movement",
        icon: <Atom className="h-6 w-6 text-blue-600" />
      },
      {
        title: "Calcium Fortification",
        description: "High levels of soluble calcium strengthen cell walls and improve structural integrity",
        icon: <Shield className="h-6 w-6 text-green-600" />
      },
      {
        title: "Micronutrient Complex",
        description: "Boron and zinc work synergistically with calcium for optimal plant metabolism",
        icon: <Zap className="h-6 w-6 text-purple-600" />
      },
      {
        title: "Quality Enhancement",
        description: "Improves crop quality, shelf life, and post-harvest performance",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div {...fadeInUp}>
              ...
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                With Ilex's proven phosphite technology to optimise healthy plant growth through superior nutrition, 
                CaPITAL is a highly effective foliar treatment specifically formulated for vegetable and salad crops.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                CaPITAL is a new generation phosphite, containing high levels of soluble calcium together with 
                the key nutrients, boron and zinc. The provision of optimum levels of calcium are important for 
                root development, maintaining plant health and strengthening cell walls for improved quality and shelf life.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <motion.div className="text-center mb-16" variants={fadeInUp}>
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover why CaPITAL™ delivers superior performance for vegetable and salad crops
            </p>
          </motion.div>
      ...
      {/* Analysis Pie Chart */}
      <AnalysisPieChart analysis={analysisData} title="CaPITAL™ Nutrient Analysis" />
                ...
                <Card className="border-0 bg-gradient-to-r from-green-50 to-blue-50">
                  <CardContent className="p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-xl font-semibold">Primary Nutrients</h3>
                    </div>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600">Phosphorus Pentoxide (P₂O₅)</span>
                        <div className="flex items-center gap-2">
                          <Badge variant="secondary" className="text-lg px-3 py-1">30% w/v</Badge>
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-2">
                          <Badge variant="secondary" className="px-3 py-1">8% w/v</Badge>
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-2">
                          <Badge variant="secondary" className="px-3 py-1">6.6% w/v</Badge>
                ...
                <Card className="border-0 bg-gradient-to-r from-blue-50 to-purple-50">
                  <CardContent className="p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-xl font-semibold">Key Micronutrients</h3>
                    </div>
                    <div className="grid grid-cols-3 gap-4">
                      <div className="text-center p-3 bg-white/50 rounded-lg">
                        <p className="text-xl font-semibold text-green-600 mb-1">2.4%</p>
                        <p className="text-sm text-gray-600">Zinc (Zn)</p>
                      </div>
                      <div className="text-center p-3 bg-white/50 rounded-lg">
                        <p className="text-xl font-semibold text-blue-600 mb-1">0.8%</p>
                        <p className="text-sm text-gray-600">Boron (B)</p>
                      </div>
                      <div className="text-center p-3 bg-white/50 rounded-lg">
                        <p className="text-xl font-semibold text-purple-600 mb-1">4%</p>
                ...
                <Card className="border-0 bg-gradient-to-r from-purple-50 to-pink-50">
                  <CardContent className="p-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <Badge variant="secondary" className="text-lg px-3 py-1">2 × 10L</Badge>
                      <Badge variant="secondary" className="text-lg px-3 py-1">1000L IBC</Badge>
                    </div>
                  </CardContent>
                </Card>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-700">
                      CaPITAL is best applied as a foliar spray at water rates of between 200-600 l/ha 
                      depending on the crop type and stage of growth.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="bg-green-50 border border-green-200">
              <CardContent className="p-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-2 text-green-800">Propagated Plants</h3>
                    <p className="text-green-700">
                      *Propagated plants will benefit from an application of CaPITAL via irrigation techniques 
                      at a rate of 3-4 mls per litre of water ideally just prior to planting out.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <div className="space-y-6">
              <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    Optimum calcium levels promote strong, healthy root systems that support 
                    vigorous plant growth and nutrient uptake.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    Maintains overall plant health through proven phosphite technology 
                    and superior calcium nutrition.
                  </p>
                </CardContent>
              </Card>
            </div>
              ...
              <div className="relative">
                <div className="w-48 h-48 mx-auto bg-gradient-to-br from-green-100 to-blue-100 rounded-full flex items-center justify-center shadow-xl">
                  <div className="text-center">
                    ...
                    <p className="text-xl font-semibold text-gray-800">Proven</p>
            ...
            <div className="space-y-6">
              <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
                <CardContent className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-xl font-semibold">Cell Wall Strength</h3>
                  </div>
                  <p className="text-gray-600">
                    Strengthens cell walls for improved crop quality, better storage 
              ...
              <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    Formulated for rapid absorption and maximum nutrient availability 
