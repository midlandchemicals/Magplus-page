            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600 mb-8 leading-relaxed max-w-4xl mx-auto">
                  Leading the way in agricultural innovation and
                  foliar nutrition solutions since our founding.
                  We are committed to providing farmers with the
                  most effective and sustainable crop nutrition
                  products.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                ...
                >
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Find authorized distributors and purchase
                ...
                >
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Our commitment to safety, quality, and
                    industry leadership.
                  </p>
                </button>
                ...
                <button
                  onClick={() =>
                    handlePageChange("product-guide")
                  }
                  className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 text-left group"
                >
                  <h3 className="text-xl font-semibold mb-3 text-gray-900 group-hover:text-blue-600 transition-colors">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Comprehensive guide to our foliar nutrition
                    solutions.
                  </p>
                </button>
                ...
                >
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Hear from farmers who trust our products for
                    their crops.
                  </p>
                </button>
                ...
                >
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Latest news and press releases from Ilex
                    EnviroSciences.
                  </p>
                </button>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  To deliver innovative, science-based foliar
                  nutrition solutions that enhance crop
                  performance, improve agricultural
                  sustainability, and support farmers in
                  achieving their yield and quality goals.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Get in touch with our agricultural experts for
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                  Purchase our products through authorized
                  distributors and agricultural suppliers
                  nationwide.
                </p>
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Contact us to locate your nearest
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      For large volume orders, contact our sales
                      team directly.
                    </p>
                  </div>
                </div>
    ...
    switch (currentPage) {
      ...
      case "product":
        if (selectedProduct?.link === "mag-plus") {
          ...
          selectedProduct?.link === "crop-rooter-plus"
        ) {
          return (
            <CropRooterPlusPage onSubmit={handleFormSubmit} />
          );
        } else if (selectedProduct?.link === "oilseed-raiser") {
          return (
            <OilSeedRaiserPage onSubmit={handleFormSubmit} />
          );
          ...
          return (
            <Complete624Page onSubmit={handleFormSubmit} />
          );
        } else if (
          selectedProduct?.link === "complete-hi-fruit-4-2-6"
        ) {
          return (
            <CompleteHiFruitPage onSubmit={handleFormSubmit} />
          );
          ...
          selectedProduct?.link === "ultimate-gold-8-7-7"
        ) {
          return (
            <UltimateGoldPage onSubmit={handleFormSubmit} />
          );
        } else {
            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 py-20 px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                  ...
                  {selectedProduct?.product} is coming soon.
                  Please contact our experts for technical
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            <p className="text-gray-400 mb-4 text-sm">
              © TM ® 2024 - Ilex EnviroSciences and all of its
              trade and product names are property of Ilex
              EnviroSciences ltd
            </p>
            <p className="text-gray-400 mb-2 text-sm">
              Company Registration Number: 04991822 | V.A.T
              Registration Number: 829 4192 07
            </p>
